...
# This worked with the json input, moved it to zotero_to_obsidian_note.py
#
...
use_json_input = True
if use_json_input:
    test_json_input_file = pl.Path(r"C:\Users\scott\OneDrive\share\ref\refwrangle\zmknote\dat\zotero_item_date_YK4TVDBM.json")
